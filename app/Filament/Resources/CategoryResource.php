...
class CategoryResource extends Resource
{
    ...
    {
        return $form->schema([Forms\Components\TextInput::make('name')->required()->maxLength(255), Forms\Components\Toggle::make('is_expense')->required(), Forms\Components\FileUpload::make('image')->image()->required()]);
    }
